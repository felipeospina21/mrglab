...
func (k PipelinesKeyMap) ShortHelp() []key.Binding {
	return slices.Concat([]key.Binding{k.Details, k.CycleTab, k.OpenInBrowser, k.RetryPipeline}, tui.CommonKeys)
}

func (k PipelinesKeyMap) FullHelp() [][]key.Binding {
	return [][]key.Binding{tui.CommonKeys, {k.Details, k.CycleTab, k.OpenInBrowser, k.RetryPipeline}}
}
